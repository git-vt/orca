...
lemma lit_arith_simps [lit_simps]:
  "\<guillemotleft>- x\<guillemotright> = - \<guillemotleft>x\<guillemotright>" "\<guillemotleft>inverse x\<guillemotright> = inverse \<guillemotleft>x\<guillemotright>"
  "\<guillemotleft>sgn x\<guillemotright> = sgn \<guillemotleft>x\<guillemotright>" "\<guillemotleft>abs x\<guillemotright> = abs \<guillemotleft>x\<guillemotright>"
  ...
  "\<guillemotleft>x * y\<guillemotright> = \<guillemotleft>x\<guillemotright> * \<guillemotleft>y\<guillemotright>" "\<guillemotleft>x / y\<guillemotright> = \<guillemotleft>x\<guillemotright> / \<guillemotleft>y\<guillemotright>"
  "\<guillemotleft>x div y\<guillemotright> = \<guillemotleft>x\<guillemotright> div \<guillemotleft>y\<guillemotright>" "\<guillemotleft>x mod y\<guillemotright> = \<guillemotleft>x\<guillemotright> mod \<guillemotleft>y\<guillemotright>"
