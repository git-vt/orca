...
lemma throw_left_zero[simp]: 
  "(THROW\<^sub>A\<^sub>B\<^sub>R ;; Simpl P) = THROW\<^sub>A\<^sub>B\<^sub>R" 
  by rel_auto 
...
lemma skip_c_left_unit[simp]: 
  "(SKIP\<^sub>A\<^sub>B\<^sub>R ;;  Simpl P) =  Simpl P"
  by rel_auto 

lemma skip_c_right_unit[simp]: 
  "(Simpl P  ;;  SKIP\<^sub>A\<^sub>B\<^sub>R) =  Simpl P"  
...
lemma skip_c_alpha_eq:
  "SKIP\<^sub>A\<^sub>B\<^sub>R = Simpl (\<not>$abrupt\<acute> \<and> $abrupt_aux\<acute> =\<^sub>u \<guillemotleft>None\<guillemotright> \<and> ($\<Sigma>\<^sub>A\<^sub>B\<^sub>R\<acute> =\<^sub>u $\<Sigma>\<^sub>A\<^sub>B\<^sub>R))"
  by (simp add: skip_c_lift_alpha_eq skip_abr_def)

lemma pre_skip_c_post: 
  "(Simpl \<lceil>b\<rceil>\<^sub>A\<^sub>B\<^sub>R\<^sub>< \<and> SKIP\<^sub>A\<^sub>B\<^sub>R) = (SKIP\<^sub>A\<^sub>B\<^sub>R \<and> Simpl \<lceil>b\<rceil>\<^sub>A\<^sub>B\<^sub>R\<^sub>>)"
  by rel_auto 

lemma skip_c_var:
  fixes x :: "(bool,  ('a, 'b) cpa) uvar"
  shows "(Simpl $x \<and> SKIP\<^sub>A\<^sub>B\<^sub>R) = (SKIP\<^sub>A\<^sub>B\<^sub>R \<and> Simpl $x\<acute>)"
  by rel_auto
...
lemma assign_c_alt_def [symbolic_exec_cp]: 
  "\<langle>\<sigma>\<rangle>\<^sub>A\<^sub>B\<^sub>R = Simpl (\<not>$abrupt\<acute> \<and> $abrupt_aux\<acute> =\<^sub>u \<guillemotleft>None\<guillemotright> \<and> \<lceil>\<lceil>\<sigma>\<rceil>\<^sub>s \<dagger> II\<rceil>\<^sub>A\<^sub>B\<^sub>R)"
  by rel_auto
...
lemma assign_c_left_comp: 
  "(\<langle>\<sigma>\<rangle>\<^sub>A\<^sub>B\<^sub>R ;; Simpl(\<lceil>P\<rceil>\<^sub>A\<^sub>B\<^sub>R \<turnstile> \<lceil>Q\<rceil>\<^sub>A\<^sub>B\<^sub>R)) = Simpl(\<lceil>\<lceil>\<sigma>\<rceil>\<^sub>s \<dagger> P\<rceil>\<^sub>A\<^sub>B\<^sub>R \<turnstile> \<lceil>\<lceil>\<sigma>\<rceil>\<^sub>s \<dagger> Q\<rceil>\<^sub>A\<^sub>B\<^sub>R)"
  by rel_auto

lemma assign_c_left_comp_subst[symbolic_exec_cp]: 
  "(x \<Midarrow> u ;; Simpl(\<lceil>P\<rceil>\<^sub>A\<^sub>B\<^sub>R \<turnstile> \<lceil>Q\<rceil>\<^sub>A\<^sub>B\<^sub>R)) = Simpl(\<lceil>P\<lbrakk>\<lceil>u\<rceil>\<^sub></$x\<rbrakk>\<rceil>\<^sub>A\<^sub>B\<^sub>R \<turnstile> \<lceil>Q\<lbrakk>\<lceil>u\<rceil>\<^sub></$x\<rbrakk>\<rceil>\<^sub>A\<^sub>B\<^sub>R)" 
  by rel_auto
...
proof -
  ...
  also have "... = SKIP\<^sub>A\<^sub>B\<^sub>R" by (simp add: aext_false)
  finally show ?thesis . 
qed
