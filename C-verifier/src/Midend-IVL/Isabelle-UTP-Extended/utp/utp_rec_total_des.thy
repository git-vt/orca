...
lemma  rec_total_rule_des: (*This does not make sens since it does not require healthiness conditions 
                                on the recursive
                             call.. TODO @Yakoub: Figure out why? it uses wf_fixp_induct_pure_des_rule
                                      maybe the latter does not make sens! ! !*)
  assumes WF: "wf R"
