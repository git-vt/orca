...
abbreviation "SIZEOF_UNSIGNED_LONG \<equiv> 64::nat" (* assuming non-Windows 64-bit architecture *)
abbreviation "PAGES_PER_MAPWORD \<equiv> \<guillemotleft>SIZEOF_UNSIGNED_LONG * 8\<guillemotright>"
...
definition "map_alloc
  ...
  (* local variables*) curr_idx start_off end_idx end_off
  =
